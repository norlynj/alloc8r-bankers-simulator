...
public class SafetyExample
{
            ...
            for (int i = 0;i < n; i++) {
                if (visited[i] == false) {
                    ...
                    if (j == m) {
                        ...
                        for (j = 0;j < m; j++)
                        {
                            System.out.println("     Work = Work + Allocation, so: " + work[j] + " + " + alloc[i][j] + " = " + (work[j] + alloc[i][j]));
    ...
    void calculateNeed()
    {
        ...
        for (int i = 0;i < n; i++) {
            System.out.print("For Process " + i + " the need is: ");
            for (int j = 0;j < m; j++)
            {
    ...
    {
        int i, j, k;
        SafetyExample gfg = new SafetyExample();
